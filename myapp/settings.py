...
BASE_DIR = os.environ.get('X_DJANGO_PROJECT_PATH', os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
...
DEBUG = bool(int(os.environ.get('MYAPP_DEBUG', '0') or '0'))
